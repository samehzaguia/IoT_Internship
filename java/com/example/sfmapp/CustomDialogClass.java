...
import static com.example.sfmapp.GlobalVariablesJava.maxTemp;
        ...
        public void onClick(View v) {
            ...
            MaxMinRef.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot snapshot) {
                    /*Object t1=snapshot.child("maxTemp").getValue();
                    Object t2=snapshot.child("minTemp").getValue();*/
                   // if (t1!=null)
                    maxTemp= Integer.parseInt(snapshot.child("maxTemp").getValue().toString());
                   // if(t2!=null)
